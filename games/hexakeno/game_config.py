...
class GameConfig(Config):
    ...
    def __init__(self):
        ...
        self.publish_path = os.path.join(_game_dir, "library", "publish_files")
        ...
        # One bet mode per risk level so the RGS generates
        # separate books and measures per-mode RTP correctly.
        self.bet_modes = [
            BetMode(
                name="classic",
                cost=1.0,
