/* --- PAYOUT DATA (REGULATORY COMPLIANT v2) --- */
const STAKE_DATA = {
    classic: {
        1: [0, 3.80],
        2: [0, 1.82, 4.32],
...
const SUPERBALL_DATA = {
    classic: {
        ...
        10: [0.00, 0.00, 0.00, 1.02, 1.64, 3.29, 5.84, 12.41, 36.95, 29.20, 18.25]
    },
    low: {
        1: [2.28, 6.06],
        2: [0.00, 2.83, 5.38],
        ...
        9: [0.00, 0.00, 0.95, 1.12, 1.46, 2.16, 6.47, 43.11, 220.95, 129.32],
        10: [0.00, 0.00, 0.94, 1.03, 1.11, 1.54, 3.00, 11.13, 45.59, 34.23, 21.40]
    },
    medium: {
        1: [0.87, 6.06],
        2: [0.00, 2.49, 7.05],
        ...
        9: [0.00, 0.00, 0.00, 1.50, 1.88, 3.76, 11.28, 75.23, 380.03, 225.68],
        10: [0.00, 0.00, 0.00, 1.18, 1.48, 2.95, 5.17, 19.20, 78.65, 59.08, 36.93]
    },
    high: {
        1: [0.00, 6.06],
        2: [0.00, 0.00, 19.11],
        3: [0.00, 0.00, 2.47, 49.48],
        4: [0.00, 0.00, 0.82, 10.81, 108.07],
        5: [0.00, 0.00, 0.00, 3.36, 35.80, 335.62],
        6: [0.00, 0.00, 0.00, 0.83, 7.34, 179.71, 473.55],
        7: [0.00, 0.00, 0.00, 0.00, 4.40, 56.63, 251.71, 503.42],
        8: [0.00, 0.00, 0.00, 0.00, 3.06, 12.24, 165.30, 367.34, 551.02],
        9: [0.00, 0.00, 0.00, 0.00, 2.47, 6.80, 34.62, 309.12, 496.98, 296.76],
        10: [0.00, 0.00, 0.00, 0.00, 2.25, 5.15, 8.36, 40.53, 325.65, 257.35, 160.84]
    }
};
...
console.log('[HexaKeno] Version 1.0.48 Loaded (Stake Release)');
