/* --- PAYOUT DATA (97% RTP — REGULATORY COMPLIANT) --- */
const STAKE_DATA = {
    classic: {
        1: [0.00, 3.88],
        2: [0.00, 1.86, 4.41],
        3: [0.00, 0.98, 3.04, 10.18],
        4: [0.00, 0.79, 1.76, 4.89, 22.02],
        5: [0.00, 0.25, 1.37, 4.03, 16.18, 35.31],
        6: [0.00, 0.00, 0.98, 3.61, 6.86, 16.18, 39.22],
        7: [0.00, 0.00, 0.46, 2.94, 4.41, 13.73, 30.39, 58.82],
        8: [0.00, 0.00, 0.00, 2.15, 3.92, 12.74, 21.56, 53.90, 68.60],
        9: [0.00, 0.00, 0.00, 1.52, 2.94, 7.84, 14.69, 43.10, 59.13, 35.26],
        10: [0.00, 0.00, 0.00, 1.37, 2.21, 4.41, 7.84, 16.67, 49.63, 39.22, 24.52]
    },
    low: {
        1: [0.69, 1.82],
        2: [0.00, 1.96, 3.73],
        3: [0.00, 1.08, 1.35, 25.48],
        4: [0.00, 0.00, 2.16, 7.75, 88.31],
        5: [0.00, 0.00, 1.47, 4.12, 12.75, 294.28],
        6: [0.00, 0.00, 1.08, 1.96, 6.06, 97.84, 684.91],
        7: [0.00, 0.00, 1.08, 1.57, 3.42, 14.67, 220.11, 684.78],
        8: [0.00, 0.00, 1.08, 1.47, 1.96, 5.38, 38.15, 97.83, 782.66],
        9: [0.00, 0.00, 1.08, 1.27, 1.66, 2.44, 7.33, 48.87, 250.51, 146.61],
        10: [0.00, 0.00, 1.08, 1.18, 1.28, 1.77, 3.43, 12.75, 52.26, 39.24, 24.53]
    },
    medium: {
        1: [0.39, 2.71],
        2: [0.00, 1.77, 5.01],
        3: [0.00, 0.00, 2.75, 48.98],
        4: [0.00, 0.00, 1.67, 9.82, 98.24],
        5: [0.00, 0.00, 1.37, 3.93, 13.74, 382.78],
        6: [0.00, 0.00, 0.00, 2.94, 8.83, 176.66, 696.82],
        7: [0.00, 0.00, 0.00, 1.96, 6.86, 29.41, 392.07, 784.14],
        8: [0.00, 0.00, 0.00, 1.96, 3.92, 10.79, 65.70, 392.22, 882.50],
        9: [0.00, 0.00, 0.00, 1.96, 2.45, 4.90, 14.71, 98.04, 495.27, 294.11],
        10: [0.00, 0.00, 0.00, 1.57, 1.96, 3.92, 6.85, 25.45, 104.24, 78.31, 48.94]
    },
    high: {
        1: [0.00, 3.88],
        2: [0.00, 0.00, 16.81],
        3: [0.00, 0.00, 2.55, 51.15],
        4: [0.00, 0.00, 0.94, 12.33, 123.23],
        5: [0.00, 0.00, 0.00, 4.41, 47.08, 441.40],
        6: [0.00, 0.00, 0.00, 1.22, 10.78, 264.01, 695.66],
        7: [0.00, 0.00, 0.00, 0.00, 6.86, 88.22, 392.07, 784.14],
        8: [0.00, 0.00, 0.00, 0.00, 4.90, 19.60, 264.66, 588.13, 882.20],
        9: [0.00, 0.00, 0.00, 0.00, 3.92, 10.78, 54.89, 490.07, 787.90, 470.47],
        10: [0.00, 0.00, 0.00, 0.00, 3.43, 7.84, 12.74, 61.72, 495.90, 391.89, 244.93]
    }
};

/* --- SUPERBALL PAYOUT DATA (97% RTP at 2.5x cost + 7x conditional) --- */
const SUPERBALL_DATA = {
    classic: {
        1: [0.00, 6.06],
        2: [0.00, 2.65, 6.27],
        3: [0.00, 1.22, 3.78, 12.66],
        4: [0.00, 0.91, 2.03, 5.64, 25.40],
        5: [0.00, 0.24, 1.34, 3.94, 15.82, 34.54],
        6: [0.00, 0.00, 0.89, 3.28, 6.23, 14.71, 35.65],
        7: [0.00, 0.00, 0.39, 2.49, 3.74, 11.65, 25.79, 49.91],
        8: [0.00, 0.00, 0.00, 1.66, 3.02, 9.82, 16.62, 41.56, 52.89],
        9: [0.00, 0.00, 0.00, 1.13, 2.19, 5.85, 10.96, 32.16, 44.12, 26.31],
        10: [0.00, 0.00, 0.00, 1.02, 1.64, 3.28, 5.83, 12.40, 36.92, 29.18, 18.24]
    },
    low: {
        1: [2.30, 6.06],
        2: [0.00, 2.83, 5.39],
        3: [0.00, 1.29, 1.61, 30.39],
        4: [0.00, 0.00, 2.04, 7.33, 83.57],
        5: [0.00, 0.00, 1.33, 3.73, 11.54, 266.38],
        6: [0.00, 0.00, 0.91, 1.64, 5.08, 82.00, 574.01],
        7: [0.00, 0.00, 0.92, 1.34, 2.93, 12.55, 188.31, 585.84],
        8: [0.00, 0.00, 0.95, 1.29, 1.72, 4.73, 33.51, 85.93, 687.50],
        9: [0.00, 0.00, 0.95, 1.12, 1.47, 2.15, 6.47, 43.13, 221.09, 129.39],
        10: [0.00, 0.00, 0.94, 1.03, 1.12, 1.54, 2.99, 11.11, 45.54, 34.19, 21.38]
    },
    medium: {
        1: [0.87, 6.06],
        2: [0.00, 2.49, 7.04],
        3: [0.00, 0.00, 2.68, 47.66],
        4: [0.00, 0.00, 1.54, 9.03, 90.32],
        5: [0.00, 0.00, 1.21, 3.47, 12.15, 338.35],
        6: [0.00, 0.00, 0.00, 2.14, 6.44, 128.78, 507.97],
        7: [0.00, 0.00, 0.00, 1.41, 4.95, 21.21, 282.79, 565.58],
        8: [0.00, 0.00, 0.00, 1.46, 2.93, 8.05, 49.03, 292.71, 658.61],
        9: [0.00, 0.00, 0.00, 1.50, 1.88, 3.76, 11.29, 75.25, 380.15, 225.75],
        10: [0.00, 0.00, 0.00, 1.18, 1.48, 2.96, 5.17, 19.19, 78.61, 59.06, 36.91]
    },
    high: {
        1: [0.00, 6.06],
        2: [0.00, 0.00, 19.11],
        3: [0.00, 0.00, 2.47, 49.50],
        4: [0.00, 0.00, 0.82, 10.81, 108.05],
        5: [0.00, 0.00, 0.00, 3.35, 35.81, 335.72],
        6: [0.00, 0.00, 0.00, 0.83, 7.34, 179.79, 473.75],
        7: [0.00, 0.00, 0.00, 0.00, 4.40, 56.64, 251.71, 503.43],
        8: [0.00, 0.00, 0.00, 0.00, 3.06, 12.24, 165.33, 367.39, 551.09],
        9: [0.00, 0.00, 0.00, 0.00, 2.47, 6.80, 34.63, 309.15, 497.03, 296.78],
        10: [0.00, 0.00, 0.00, 0.00, 2.25, 5.15, 8.36, 40.52, 325.57, 257.28, 160.80]
    }
};
...
console.log('[HexaKeno] Version 1.0.49 Loaded (Stake Release)');
