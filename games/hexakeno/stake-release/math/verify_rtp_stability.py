...
if __name__ == "__main__":
    ...
    print("\n--- Verifying SUPERBALL (Medium Risk) ---")
    # Verify Superball on Medium
    # Creating a separate logic or just a quick check here?
    # Ideally should repurpose simulate_hits, but it hardcodes use_superball=False.
    # I'll rely on run.py for mixed verification, just fixed the config.
    # Actually, let's create a separate test function or modify simulate_hits if easy.
    # For now, just fix the config. run.py is the active "User Request".
